...
<html>
    ...
    <body>
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-6">
			        <h2>Update Profile for "${updatedWeighter.username}"</h2>
			        
			        <sf:form method="POST" commandName="updatedWeighter">
						<sf:input type="hidden" path="username" value="${updatedWeighter.username}" />
			            ...
			            Last Name: <sf:input path="lastName" />
			                ...
			                <br/>
			            Old Password  : <sf:password path="oldPassword" />
			                <sf:errors path="oldPassword" cssClass="error"/>
			                    <br/>
			            New Password  : <sf:password path="password" />
			            ...
			            <div id="ifFemale" style="display:none">
			             ...
			             <div id="ifNotChild" style="display:none">
				            Sport Factor: <br/>
				            <sf:radiobutton path="sportFactor" value="0.5"/>                No training at all           <br/>
		        ...
		        <div class="col-sm-6">
			        ...
			        <h4>Go back to your <a href="<c:url value="/profile" />">profile</a> page!</h4>
